...
Current research explores whether metacognitive monitoring is a fundamental functional requirement for intelligence, and whether XAI can generate epistemically legitimate knowledge despite imperfect model fidelity. Increasingly, I'm drawn to using neural networks of varying scales and architectures — from RNNs to LLMs — as cognitive models that we can probe to better understand the computational principles underlying humans. I’m also interested in whether we can measure and operationalise metacognitive functions and subjective "feelings" in machines. 