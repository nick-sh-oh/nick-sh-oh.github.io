// Minimal inline SVG icons (no external icon font / CDN dependency).
// All use a 24x24 viewBox; brand marks use their official path data.
...
export const XIcon = (props) => (
  <svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor" {...props}>
    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.65l-5.214-6.817-5.963 6.817H1.69l7.73-8.835L1.254 2.25h6.817l4.713 6.231 5.46-6.231zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" />
  </svg>
);

export const SubstackIcon = (props) => (
  <svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor" {...props}>
